...
export const TagsStoreContext = createContext<TagsStoreApi | undefined>(undefined)

export interface TagsStoreProviderProps {
  children: React.ReactNode
}

export const TagsStoreProvider = ({
  children
}: TagsStoreProviderProps) => {
...
export const useTagsStore = <T,>(
  selector: (state: TagsStore) => T,
): T => {
