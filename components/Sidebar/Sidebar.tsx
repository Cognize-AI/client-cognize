...
import { Dashboard, Settings, Tag } from "../icons"
  ...
  return (
    <div className={styles.sidebar}>
      ...
      <div className={styles.actions}>
        <Link className={`${styles.link} ${pathname === "/kanban" ? styles.active : ""}`} href={"/kanban"}>
          <Dashboard width={20} height={20} fill={pathname === "/kanban" ? "#194EFF": "#3D3D3D"} />
          <p>Dashbaords</p>
        </Link>
        ...
        <Link className={`${styles.link} ${pathname === "/profile" ? styles.active : ""}`} href={"/profile"}>
          <Settings width={20} height={20} fill={pathname === "/profile" ? "#194EFF": "#3D3D3D"} />
          <p>Profile</p>
        </Link>
      </div>
