  ...
  return (
    <div className={styles.sidebar}>
      ...
      <div className={styles.actions}>
        <Link
          className={`${styles.link} ${isKanbanActive ? styles.active : ""}`}
          href={"/kanban"}
        >
          <Dashboard
            width={20}
            height={20}
            fill={isKanbanActive ? "#194EFF" : "#3D3D3D"}
          />
          <p>Dashboards</p>
        </Link>
        <Link
        ...
        >
          <Tag
            width={20}
            height={20}
            fill={pathname === "/tags" ? "#194EFF" : "#3D3D3D"}
          />
          <p>Tag Management</p>
        </Link>
        <Link
        ...
        >
          <Settings
            width={20}
            height={20}
            fill={pathname === "/settings" ? "#194EFF" : "#3D3D3D"}
          />
          <p>Settings</p>
        </Link>
        <Link
